<%-- 
    Document   : ListeEtapeCourseDetailAdmin
    Created on : 5 juin 2024, 09:56:06
									...
									<table class="table table-hover my-0">
										...
										<tbody>
											...
											<tr>
                                                                                            ...
                                                                                            <td class="d-none d-xl-table-cell"><%= etape.getLongueur()%></td>
                                                                                            <td class="d-none d-md-table-cell"><%= etape.getDateheuredepart()%></td>
                                                                                            <td class="d-none d-md-table-cell"><%= etape.getNbrcoureurequipe()%></td>
                                                                                            <td>
                                                                                                <form action="/UltimateRaceTeam/DetailClassementIndividuelEtapeServlet" method="post">
                                                                                                    <input type="hidden" name="idEtape" value="<%= etape.getIdetape()%>">
                                                                                                    <button class="btn btn-success btn-sm">Voir Resultat</button>
                                                                                                </form>
                                                                                            </td>
                                                                                        </tr>
                                                                                    <%}%>
