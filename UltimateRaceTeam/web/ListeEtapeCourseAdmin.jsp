<%-- 
    ...
    Created on : 1 juin 2024, 21:21:40
									...
									<table class="table table-hover my-0">
										...
										<tbody>
											...
											<tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <form action="/UltimateRaceTeam/FormulaireAffectationTempsCoureurServlet" method="post">
                                                                                                    <input type="hidden" name="idEtape" value="<%= etape.getIdetape()%>">
                                                                                                    <button class="btn btn-success btn-sm">Affecter Temps Coureur</button>
                                                                                                </form>
                                                                                            </td>
                                                                                        </tr>
                                                                                    <%}%>
